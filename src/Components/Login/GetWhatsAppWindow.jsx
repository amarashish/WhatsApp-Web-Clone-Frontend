  ...
  return (
      <Box className="get-whatapp-windows">
        ...
        <Box style={{ padding: "0 24px" }}>
          <Typography variant="h6" className="get-whatapp-windows-content" style={{fontSize:"1.0625rem", color:"#111b21", lineHeight:"1.2941"}}>
            Download WhatsApp for Windows
          </Typography>
          <Typography variant="h8" style={{fontSize:"0.875rem", color:"#54656f", lineHeight:"1.4286"}}>
